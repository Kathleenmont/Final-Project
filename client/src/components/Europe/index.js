      ...
      <div className="image-container-europe">
        ...
        <div>
          <span
            ...
            data-type="Polish"
          />
          <span id="hover-poland" className="country-text">Poland</span>
          <span
            ...
            data-type="Greek"
          />
          <span id="hover-greece" className="country-text">Greece</span>
          <span
            ...
            data-type="Spanish"
          />
          <span id="hover-spain" className="country-text">Spain</span>
        </div>
      </div>
    </div>
  );
